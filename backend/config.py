...
API_PUBLIC_PRE_REG_RATE_LIMIT_ATTEMPTS = int(os.getenv("API_PUBLIC_PRE_REG_RATE_LIMIT_ATTEMPTS", "10"))
API_PUBLIC_PRE_REG_RATE_LIMIT_WINDOW_SECONDS = int(os.getenv("API_PUBLIC_PRE_REG_RATE_LIMIT_WINDOW_SECONDS", "300"))
API_PUBLIC_PRE_REG_BLOCK_SECONDS = int(os.getenv("API_PUBLIC_PRE_REG_BLOCK_SECONDS", "900"))
